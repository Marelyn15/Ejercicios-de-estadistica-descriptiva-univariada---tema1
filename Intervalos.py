...
def tabla_frecuencia_intervalos(intervals,datos_ord_intervalos):
    print("Ejercicios de intervalos")
    ...
    indice_valor_indicado = intervals[indice_datos_centralizados] 
    print(f"Esto es la Seleccion de la clase  {indice_valor_indicado}")

    #Esto es eñ extremo inferior del intervalo de la mediana 
    Li = indice_valor_indicado[0] 
    print(f"Esto es eñ extremo inferior del intervalo de la mediana {Li}")

    #Frecuencia absoluta acumulada de la clase anterior
    if indice_datos_centralizados == 0:
        Ni_clase_anterior = 0
        print(f"Esto es la Frecuencia absoluta acumulada de la clase anterior  {Ni_clase_anterior}")
    else:
        Ni_clase_anterior = Ni[indice_datos_centralizados - 1] 
        print(f"Esto es la Frecuencia absoluta acumulada de la clase anterior  {Ni_clase_anterior}")

    #Frecuencia absoluta de la clase de la mediana (este caso de la que elegimos)
    FAM = datos_ord_intervalos[indice_datos_centralizados] 
